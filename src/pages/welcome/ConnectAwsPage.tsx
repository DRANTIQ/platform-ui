...
import { AwsTrustPanel } from "../../components/welcome/AwsTrustPanel";
import { FieldTooltip } from "../../components/welcome/FieldTooltip";
...
export function ConnectAwsPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (!accountId || accountId.length !== 12) {
      setError("Paste your Role ARN from CloudFormation — we'll detect your account ID automatically.");
      return;
    }
  ...
  if (connecting) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-bold text-slate-900">Connecting your AWS account…</h1>
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-1 text-2xl font-bold text-slate-900">Connect your AWS account securely</h1>
