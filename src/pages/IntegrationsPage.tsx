...
type FormProvider = "aws" | "azure" | null;
...
export function IntegrationsPage() {
  ...
  function openForm(provider: FormProvider) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            ...
            Connect AWS accounts and Azure subscriptions for {copy.productName.toLowerCase()}
        ...
        {canWrite && (
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              onClick={() => (formProvider === "aws" ? setFormProvider(null) : openForm("aws"))}

              className="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800"

            >

              {formProvider === "aws" ? "Cancel" : "Add AWS"}
            ...
            <button
              ...
              onClick={() => (formProvider === "azure" ? setFormProvider(null) : openForm("azure"))}

              className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-50"

            >

              {formProvider === "azure" ? "Cancel" : "Add Azure"}
      ...
      {formProvider === "azure" && canWrite && (
        ...
        <ConnectAzureForm
          ...
          submitLabel="Add Azure subscription"
              ...
              <tr key={item.id} className="hover:bg-slate-50">
                ...
                <td className="px-4 py-3">
                  ...
                  <span className="rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-700">
                    ...
                    {providerBadgeLabel(item.provider)}
                ...
                <td className="px-4 py-3 text-slate-600">
                  ...
                  {item.regions.length > 5
                    ...
                    ? `${item.regions.length} ${item.provider === "azure" ? "locations" : "regions"}`
